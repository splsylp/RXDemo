...
typedef enum : NSUInteger {
    RXTitleColorGradientStyleRGB,
    RXTitleColorGradientStyleFill,
} RXTitleColorGradientStyle;
...
@interface RXDisplayViewController : UIViewController
...
//----------------gy-------------------
@property (nonatomic,assign) BOOL     titleLableOnNavigationBar;
...
/**
 颜色渐变样式
 */
@property (nonatomic, assign) RXTitleColorGradientStyle titleColorGradientStyle;
...
// 一次性设置所有颜色渐变属性
- (void)setUpTitleGradient:(void(^)(BOOL *isShowTitleGradient,RXTitleColorGradientStyle *titleColorGradientStyle,CGFloat *startR,CGFloat *startG,CGFloat *startB,CGFloat *endR,CGFloat *endG,CGFloat *endB))titleGradientBlock;
