...
#import "QFoundation.h"
     ...
     */
    Q_EXTERN QCoordinateRegion QCoordinateRegionMakeWithDistance(CLLocationCoordinate2D centerCoordinate, CLLocationDistance latitudinalMeters, CLLocationDistance longitudinalMeters);
    ...
    Q_EXTERN const QMapRect QMapRectNull;
     ...
     *  @return 平面投影坐标
     */
    Q_EXTERN QMapPoint QMapPointForCoordinate(CLLocationCoordinate2D coordinate);
     ...
     *  @return 经纬度坐标
     */
    Q_EXTERN CLLocationCoordinate2D QCoordinateForMapPoint(QMapPoint mapPoint);
     ...
     *  @return region
     */
    Q_EXTERN QCoordinateRegion QCoordinateRegionForMapRect(QMapRect rect);
     ...
     *  @return 平面投影矩形
     */
    Q_EXTERN QMapRect QMapRectForCoordinateRegion(QCoordinateRegion region);
     ...
     *  @return 距离大小
     */
    Q_EXTERN CLLocationDistance QMetersPerMapPointAtLatitude(CLLocationDegrees latitude);
     ...
     *  @return mapPoint个数
     */
    Q_EXTERN double QMapPointsPerMeterAtLatitude(CLLocationDegrees latitude);
     ...
     *  @return 距离值
     */
    Q_EXTERN CLLocationDistance QMetersBetweenMapPoints(QMapPoint a, QMapPoint b);
     ...
     *  @return 面积 单位:平方米
     */
    Q_EXTERN double QAreaBetweenCoordinates(CLLocationCoordinate2D leftTop, CLLocationCoordinate2D rightBottom);
     ...
     *  @return 是否在内
     */
    Q_EXTERN BOOL QMapRectContainsPoint(QMapRect rect, QMapPoint point);
     ...
     *  @return 是否相交
     */
    Q_EXTERN BOOL QMapRectIntersectsRect(QMapRect rect1, QMapRect rect2);
     ...
     *  @return 是否包含
     */
    Q_EXTERN BOOL QMapRectContainsRect(QMapRect rect1, QMapRect rect2);
     ...
     *  @return 并集
     */
    Q_EXTERN QMapRect QMapRectUnion(QMapRect rect1, QMapRect rect2);
     ...
     */
    Q_EXTERN QMapRect QMapRectIntersection(QMapRect rect1, QMapRect rect2);
     ...
     *  @return 是否在内
     */
    Q_EXTERN BOOL QCircleContainsPoint(QMapPoint point, QMapPoint center, double radius);
     ...
     *  @return 是否在内
     */
    Q_EXTERN BOOL QCircleContainsCoordinate(CLLocationCoordinate2D point, CLLocationCoordinate2D center, double radius);
     ...
     *  @return 是否在内
     */
    Q_EXTERN BOOL QPolygonContainsPoint(QMapPoint point, QMapPoint *polygon, NSUInteger count);
     ...
     *  @return 是否在内
     */
    Q_EXTERN BOOL QPolygonContainsCoordinate(CLLocationCoordinate2D point, CLLocationCoordinate2D *polygon, NSUInteger count);
 ...
 */
Q_EXTERN @interface NSValue (NSValueQGeometryExtensions)
