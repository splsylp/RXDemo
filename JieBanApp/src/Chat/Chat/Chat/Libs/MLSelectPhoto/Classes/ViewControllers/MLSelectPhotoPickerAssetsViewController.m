...
- (void)setDoneString:(NSString *)doneString{
    ...
    [_doneBtn setTitle:(_doneString && ![_doneString isEqualToString:@""]) ? _doneString : @"发送" forState:UIControlStateNormal];
}
...
- (UIButton *)doneBtn{
    if (!_doneBtn) {
        ...
        [rightBtn setTitle:(_doneString && ![_doneString isEqualToString:@""]) ? _doneString : @"发送" forState:UIControlStateNormal];
