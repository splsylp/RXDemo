...
//        _circleLayer.strokeColor = [UIColor colorWithRed:61/255.0 green:198/255.0 blue:124/255.0 alpha:1].CGColor;
        _circleLayer.strokeColor = ThemeColor.CGColor;
...
//        _label.textColor = [UIColor colorWithRed:61/255.0 green:198/255.0 blue:124/255.0 alpha:1];
        _label.textColor = ThemeColor;
        _label.text = @"按住拍";
