...
///会话未读消息数目
@property(nonatomic ,strong) UIButton *sessionUnread;
///同事圈红点
@property(nonatomic ,strong) UIImageView *unreadImage;
///应用商店红点
@property(nonatomic ,strong) UIImageView *myAppStoreUnreadView;
///好友申请未读数目
@property(nonatomic ,strong) UIButton *unreadFriendCount;
