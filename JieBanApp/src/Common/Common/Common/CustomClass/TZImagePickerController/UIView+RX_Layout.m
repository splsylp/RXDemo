...
@implementation UIView (RX_Layout)
...
+ (void)showOscillatoryAnimationWithLayer:(CALayer *)layer type:(RX_TZOscillatoryAnimationType)type{
    NSNumber *animationScale1 = type == RX_TZOscillatoryAnimationToBigger ? @(1.15) : @(0.5);
    NSNumber *animationScale2 = type == RX_TZOscillatoryAnimationToBigger ? @(0.92) : @(1.15);
