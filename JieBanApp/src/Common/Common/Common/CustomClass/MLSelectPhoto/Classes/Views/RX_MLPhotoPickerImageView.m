...
@interface RX_MLPhotoPickerImageView ()
...
@implementation RX_MLPhotoPickerImageView
...
- (UIImageView *)videoView{
    if (!_videoView) {
        ...
        videoView.image = ThemeImage(MLSelectPhotoSrcName(@"video"));
...
- (UIImageView *)tickImageView{
    if (!_tickImageView) {
        ...
        tickImageView.image = ThemeImage(MLSelectPhotoSrcName(@"AssetsPickerChecked"));
