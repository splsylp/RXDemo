...
@interface RX_MLSelectPhotoPickerGroupTableViewCell ()
...
@implementation RX_MLSelectPhotoPickerGroupTableViewCell
...
- (UILabel *)groupPicCountLabel{
    if (!_groupPicCountLabel) {
        ...
        groupPicCountLabel.font = ThemeFontMiddle;
...
- (void)setGroup:(RX_MLSelectPhotoPickerGroup *)group{
    _group = group;
