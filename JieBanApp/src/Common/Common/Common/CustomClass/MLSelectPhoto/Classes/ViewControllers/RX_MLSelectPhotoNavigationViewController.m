...
@interface RX_MLSelectPhotoNavigationViewController ()

@end

@implementation RX_MLSelectPhotoNavigationViewController
...
//    [self.navigationBar setBackgroundImage:ThemeImage(@"taohanglan_.png") forBarMetrics:UIBarMetricsDefault];
