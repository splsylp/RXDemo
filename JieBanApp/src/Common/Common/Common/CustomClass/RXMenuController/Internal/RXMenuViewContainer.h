...
@interface RXMenuViewContainer : UIView
...
/**
 menuView
 */
@property(nonatomic, strong) RXMenuDefaultView *menuView;
 ...
 */
@property(nonatomic, assign) RXMenuControllerArrowDirection arrowDirection ;
