...
- (void)layoutSubviews {
    ...
    if (self.imagePosition == RXAdjustButtonIMGPositionLeft) {
        return;
    }
    ...
    if (self.imagePosition == RXAdjustButtonIMGPositionTop || self.imagePosition == RXAdjustButtonIMGPositionBottom) {
        ...
        if (self.imagePosition == RXAdjustButtonIMGPositionTop) {
    ...
    } else if (self.imagePosition == RXAdjustButtonIMGPositionRight) {
